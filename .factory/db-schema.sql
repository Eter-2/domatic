...
-- Initial monthly partitions (bootstrap — Alembic migration creates future ones)
-- Pattern: device_states_YYYY_MM
...
CREATE TABLE automations (
    ...
    -- Example: [{"type": "mqtt_publish", "topic": "cmnd/sonoff-02/POWER", "payload": "ON"}, {"type": "ha_service", "domain": "light", "service": "turn_off", "entity_id": "light.bedroom"}]
...
INSERT INTO rooms (name, icon, floor, color) VALUES
    ...
    ('Master Bedroom','bed-double',    1,  '#8B5CF6'),
    ('Bedroom 2',    'bed',            1,  '#F59E0B'),
